return {
  ...
  -- Additional key mappings for buffer management:
    ...
    vim.keymap.set("n", "<leader>b|", "<cmd>vsplit<CR>", { desc = "Open current buffer in a vertical split" })
    vim.keymap.set("n", "<leader>bh", "<cmd>split<CR>", { desc = "Open current buffer in a horizontal split" })
