-- Smart buffer cleanup to improve performance
-- Automatically close hidden buffers that haven't been used recently
...
-- Periodically clean up old buffers (every 5 minutes)
